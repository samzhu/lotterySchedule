...
/**
 * The persistent class for the v2_lotto_power database table.
 * 
 */

@Data
@Entity
@Table(name="v2_lotto_power")
@NamedQuery(name="V2LottoPower.findAll", query="SELECT v FROM V2LottoPower v")
public class V2LottoPower implements Serializable {
