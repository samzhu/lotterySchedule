...
@Component
public class TodayWinCount {
	private String url = "http://www.taiwanlottery.com.tw/lotto/DailyCash/history.aspx";
	...
	public Integer parser(String round){
		...
		try {
			...
			.add("SuperLotto638Control_history1$DropDownList1", "5")
			...
			String win = doc.select("#D539Control_history1_dlQuery_D539_CategA2_0").text().trim();
