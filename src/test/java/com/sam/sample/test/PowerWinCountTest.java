...
public class PowerWinCountTest {

	public static void main(String[] args) {
		String round = "104000074";
		String url = "http://www.taiwanlottery.com.tw/lotto/superlotto638/history.aspx";
		...
		try {
			...
			.add("SuperLotto638Control_history1$DropDownList1", "1")
			...
			String win = doc.select("#SuperLotto638Control_history1_dlQuery_SL638_CategA3_0").text().trim();
			if(win.length() != 0){
